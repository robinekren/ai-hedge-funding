...
export default function LiveTrades() {
  const [positions] = useState([
    { id: 'pos-1', ticker: 'PLTR', quantity: 150, entry_price: 24.30, current_price: 27.85, unrealized_pnl: 532.50, strategy: 'WSB Steady Accumulator v3' },
    { id: 'pos-2', ticker: 'SOFI', quantity: 300, entry_price: 8.45, current_price: 9.72, unrealized_pnl: 381.00, strategy: 'Penny Chatter Reversal' },
    { id: 'pos-3', ticker: 'NVDA', quantity: 20, entry_price: 875.20, current_price: 921.50, unrealized_pnl: 926.00, strategy: 'r/stocks Momentum Alpha' },
    { id: 'pos-4', ticker: 'AMD', quantity: 80, entry_price: 162.40, current_price: 168.90, unrealized_pnl: 520.00, strategy: 'Spike Exit Sniper v2' },
    { id: 'pos-5', ticker: 'RIVN', quantity: 200, entry_price: 17.60, current_price: 16.85, unrealized_pnl: -150.00, strategy: 'Penny Chatter Reversal' },
    { id: 'pos-6', ticker: 'AAPL', quantity: 40, entry_price: 189.50, current_price: 193.20, unrealized_pnl: 148.00, strategy: 'r/stocks Momentum Alpha' },
    { id: 'pos-7', ticker: 'MARA', quantity: 250, entry_price: 22.10, current_price: 24.75, unrealized_pnl: 662.50, strategy: 'WSB Steady Accumulator v3' },
    { id: 'pos-8', ticker: 'TSLA', quantity: 15, entry_price: 242.80, current_price: 251.30, unrealized_pnl: 127.50, strategy: 'Theta Gang Contrarian' },
    { id: 'pos-9', ticker: 'COIN', quantity: 35, entry_price: 225.60, current_price: 218.40, unrealized_pnl: -252.00, strategy: 'Spike Exit Sniper v2' },
    { id: 'pos-10', ticker: 'RKLB', quantity: 400, entry_price: 6.82, current_price: 7.45, unrealized_pnl: 252.00, strategy: 'Penny Chatter Reversal' },
    { id: 'pos-11', ticker: 'META', quantity: 18, entry_price: 502.30, current_price: 515.80, unrealized_pnl: 243.00, strategy: 'r/stocks Momentum Alpha' },
    { id: 'pos-12', ticker: 'IONQ', quantity: 180, entry_price: 12.40, current_price: 13.15, unrealized_pnl: 135.00, strategy: 'WSB Steady Accumulator v3' },
  ])

  const [pendingProposals] = useState([
  ...
  const [recentFills] = useState([
    { id: 'fill-1', action: 'buy', quantity: 150, ticker: 'PLTR', fill_price: 24.30, time: '14:32:08', pnl: null },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <span className={clsx(
            'font-bold',
            totalUnrealizedPnl >= 0 ? 'text-terminal-green' : 'text-terminal-red'
          )}>
      ...
      <div className="card border border-terminal-amber/30">
        <h3 className="text-terminal-amber text-sm font-bold mb-4">
          PENDING PROPOSALS — Awaiting Approval ({pendingProposals.length})
        </h3>
              ...
              {pendingProposals.map((p) => (
                <tr key={p.id} className="border-b border-terminal-border/50">
                  ...
                  <td className="py-2 text-right">
                    <span className={clsx(
                      'font-bold',
                      p.confidence >= 0.9 ? 'text-terminal-green' : 'text-terminal-amber'
                    )}>
