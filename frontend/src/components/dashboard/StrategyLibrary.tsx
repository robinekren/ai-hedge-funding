    ...
    <div className="space-y-6">
      ...
      <div className="card border border-terminal-green/20">
        ...
        <p className="text-xs text-terminal-text-dim mb-3">
          Strategy Engine + Meta Learner generate new backtest variations autonomously.
          In Phase 1, all new strategies require approval before deployment.
        </p>
        <div className="flex items-center gap-3">
          <button
            ...
            className={clsx(
              'btn-primary text-xs',
              backtestRunning && 'opacity-50 cursor-not-allowed'
            )}
          >
          ...
          {backtestRunning && (
            <span className="text-terminal-green text-xs animate-pulse">
              Generating strategy variations...
            </span>
          )}
        </div>
              ...
              {filtered.map((s, i) => (
                <tr key={s.id} className="border-b border-terminal-border/50 hover:bg-terminal-green/5">
                  ...
                  <td className={clsx(
                    ...
                    s.win_rate >= 0.9 ? 'text-terminal-green' :
                    s.win_rate >= 0.8 ? 'text-terminal-text' :
                    'text-terminal-amber'
                  )}>
                  ...
                  <td className={clsx(
                    'py-2 text-right',
                    s.sharpe_ratio >= 2.5 ? 'text-terminal-green font-bold' : 'text-terminal-text'
                  )}>
